...
struct block* class_getClassMethod(class*, struct clockwork_vm*, char*);
struct block* class_getInstanceMethod(class*, struct clockwork_vm*, char*);
struct block* class_findClassMethod(class*, struct clockwork_vm*, char*);
